...
public static class VatRetentionQueries
{
    public static IQueryable<VatRetentionEntry> BuildRetentionsQuery(
        ...
        short year)
    {
        ...
        var purchases = dbContext.PurchaseRetentions
            .Where(r =>
                r.Month == month &&
                r.Year == year &&
